...
optimizer = dict(_delete_=True, type='SGD', lr=7e-5, momentum=0.9, weight_decay=3e-04, paramwise_cfg=dict(norm_decay_mult=0))
lr_config = dict(_delete_=True,policy='CosineAnnealing',min_lr=0,by_epoch=False,)
